...
# Dataset generation
The dataset generation code is written for imagemagickv6. It would work for imagemagickv7 but you will have a lots of warnings. Dataset can be generate for eng-hin or hin-eng. It can be done running following command.
```bash
